...
import { useUpdateUserMutation, useGetUserByIdQuery } from "@/services/api";
  ...
  return (
    <SafeAreaView>
      <View className="w-full flex flex-row justify-between gap-2 bg-white border-t border-b border-gray-200 px-6 py-4 items-center">
        ...
        <Text className="text-xl font-bold text-center">Edit User</Text>
      </View>
      <View className="px-6 py-4">
        <FormControl>
          ...
          <Button
            ...
            disabled={isUpdating}
          >
            <ButtonText>{isUpdating ? "Saving..." : "Submit"}</ButtonText>
          </Button>
        </FormControl>
      </View>
    </SafeAreaView>
