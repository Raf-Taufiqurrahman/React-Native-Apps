...
const inputStyle = tva({
  base: 'border-background-300 flex-row overflow-hidden content-center data-[hover=true]:border-sky-500 data-[focus=true]:border-sky-500 data-[focus=true]:hover:border-sky-500 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-sky-300 items-center',
